        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="flex items-center gap-4">
                ...
                <h2 class="text-3xl font-black text-gray-800 leading-tight border-l-2 border-gray-200 pl-4">
                    <span class="text-blue-600">Laporan</span> Rekam Data Pasien
                </h2>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-12 min-h-screen bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            <div class="bg-white rounded-[2rem] shadow-sm border border-slate-100 p-8 text-center">
                ...
                <h3 class="text-2xl font-bold text-slate-700 mb-2">Rekam Data Pasien</h3>
                <p class="text-slate-500">Data arsip dan informasi rekam medis pasien yang dikumpulkan sistem.</p>
            </div>
        </div>
    </div>
</x-app-layout>